...
const Articles = ({name}) => {
  return (<>
    ...
    <div className='flex flex-wrap gap-20 '>
            ...
            <div className="max-w-sm scale-90 hover:scale-[1] transitionall h-[320px] font-prosans relative w-[300px] bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="https://www.bbrfoundation.org/blog/homelessness-and-mental-illness-challenge-our-society"> 
                        <img className="pt-4 rounded-t-lg h-[300px] w-full object-cover" src="https://imgs.search.brave.com/HQoBvOC3ZAvef69jkqXduZJAmBeudu8i49RjX_BCCmk/rs:fit:681:454:1/g:ce/aHR0cDovL3d3dy5r/dmNjZG9jcy5jb20v/S1ZDQy8yMDE2LU1I/VC9NSFQxMjUvc3Bl/Y2lhbC9ob21lbGVz/cy9Ib21lbGVzcy1T/aWduLmpwZw " alt="cover" />
                </a>
                <div className="p-5">
                    <a href="#" className='flex mb-2 items-center justify-between'>
                        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        ...
                        <Link href="https://www.bbrfoundation.org/blog/homelessness-and-mental-illness-challenge-our-society" >
                            <div className='absolute transitionall cursor-pointer bg-white self-center -bottom-3 left-[34%] p-[.4545rem] px-6 dark-shadows rounded-xl'>
                            View
                            </div>
                        </Link>
            ...
            <div className="max-w-sm scale-90 hover:scale-[1] transitionall h-[320px] font-prosans relative w-[300px] bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="https://www.helpguide.org/articles/addictions/substance-abuse-and-mental-health.htm"> 
                        <img className="pt-4 rounded-t-lg h-[300px] w-full object-cover" src="https://imgs.search.brave.com/2RqXplUIJBFrTGuM7ASU_Fy_3GswsaTCkctYJd0h_Aw/rs:fit:1200:1200:1/g:ce/aHR0cHM6Ly93d3cu/b2dsZXRob3JwZWlu/Yy5jb20vd3AtY29u/dGVudC91cGxvYWRz/LzIwMTkvMDQvYW54/aWV0eS5qcGc " alt="cover" />
                </a>
                <div className="p-5">
                    <a href="#" className='flex mb-2 items-center justify-between'>
                        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
